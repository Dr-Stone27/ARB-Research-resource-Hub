...
import { ResearchCard, type ResearchPaper, type ResearchCategory } from "@/components/research-card"
...
export default function Home() {
  ...
  const filteredPapers =
    activeCategory === "all" ? researchPapers : researchPapers.filter((paper) => paper.category === activeCategory)
    ...
    <div className="flex min-h-screen flex-col bg-[#0f0f1a]">
            ...
            <div className="flex flex-col space-y-6">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-400 max-w-xl">
                  A platform dedicated to showcasing exceptional engineering research projects, fostering collaboration,
      ...
      <section className="w-full bg-[#0f0f1a] border-t border-gray-800">
        <div className="text-center pt-16 pb-8">
          <h2 className="text-3xl font-bold tracking-tight text-white">Faculty of Engineering</h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <div className="space-y-2 max-w-3xl">
              <h2 className="text-3xl font-bold tracking-tight md:text-4xl text-white">Featured Research</h2>
              <p className="text-lg text-gray-400">
                Explore groundbreaking engineering research across various disciplines
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPapers.map((paper) => (
              <ResearchCard key={paper.id} paper={paper} onTagClick={handleTagClick} />
            ))}
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-lg text-gray-400">
                Join our community of researchers and showcase your work to a global audience. Get recognized for your
                contributions and connect with peers in your field.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
            ...
            <div className="flex-1 flex justify-center">
              <div className="relative w-full max-w-md">
                ...
                <div className="relative bg-[#1c1c2b] rounded-2xl shadow-[0_0_15px_rgba(79,70,229,0.2)] p-8 border border-gray-800">
                  ...
                  <h3 className="text-xl font-bold text-center mb-2 text-white">Submission Process</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                A platform dedicated to showcasing exceptional research projects, fostering collaboration, and advancing
                academic excellence.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="text-gray-500 hover:text-indigo-400 transition ease-in-out duration-300">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="#" className="text-gray-400 hover:text-indigo-400 transition ease-in-out duration-300">
                    Research Guidelines
                  </Link>
                </li>
                <li>
