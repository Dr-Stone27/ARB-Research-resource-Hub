...
export function DepartmentCarousel() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 opacity-30"></div>
      ...
      <div className="absolute left-4 top-1/2 z-10 -translate-y-1/2">
        <Button
          variant="ghost"
          size="icon"
          className="h-10 w-10 rounded-full bg-background/80 backdrop-blur-sm text-white hover:bg-white/20"
          onClick={handlePrev}
        >
            ...
            <div className="mx-auto max-w-7xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  ...
                  <h3 className="text-3xl font-bold tracking-tight text-white">{dept.name}</h3>
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href={`/categories/${dept.shortName.toLowerCase()}`}>Explore {dept.shortName} Research</Link>
                  </Button>
                </div>
